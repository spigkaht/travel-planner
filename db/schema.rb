...
ActiveRecord::Schema[7.1].define(version: 2025_05_17_133523) do
  ...
  create_table "city_trips", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_city_trips_on_city_id"
    t.index ["trip_id"], name: "index_city_trips_on_trip_id"
  end
  ...
  create_table "citytrips", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_citytrips_on_city_id"
    t.index ["trip_id"], name: "index_citytrips_on_trip_id"
  end
  ...
  add_foreign_key "city_trips", "cities"
